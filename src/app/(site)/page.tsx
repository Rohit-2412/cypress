    ...
    return (
        <>
            <section
                ...
                sm:px-6 mt-10 sm:flex sm:flex-col 
                gap-4 
        ...
        "
                >
                    <TitleSection
                        ...
                        subheading="Join thousands of satisfied users who rely on our platform 
                        for their personal and professional productivity needs."
                        pill="Testimonials"
                    />
                    {[...Array(2)].map((_arr, index) => (
                        <div
                            key={randomUUID()}
                            className={twMerge(
                                clsx(
            ...
            <section className="mt-20 relative px-4 sm:px-6">
                <TitleSection
